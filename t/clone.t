...
sets the remote name of the cloned-from repository::

  $ git dirs clone -o asdf file://$PWD/.git-dirs/repo.d/fubar fubar4
  ...
  $ git dirs clone -o qwer --no-activate file://$PWD/.git-dirs/repo.d/fubar fubar5
  cloned .git-dirs/repo.d/fubar5 from file://*/fubar (glob)

  $ git config --file .git-dirs/repo.d/fubar5/config --get remote.origin.url
  [1]
  $ git config --file .git-dirs/repo.d/fubar5/config --get remote.qwer.url
  file://*/fubar (glob)
